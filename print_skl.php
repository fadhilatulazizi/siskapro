...
// Mengambil deretan ID siswa (contoh format: print_massal.php?ids=1,2,3)
...
.page{
    ...
    position:relative;
    overflow:hidden;
    page-break-after: always; /* Membuat halaman baru otomatis saat dicetak massal */
}
/* ================= WATERMARK ================= */
.watermark{
    position:absolute;
...
@media print{
    body{ background:#fff; }
    .page{ width:100%; margin:0; padding:20px 30px; box-shadow:none; }
}
</style>
</head>
<body>
...
foreach ($ids as $id): 
    ...
    // 1. AMBIL DATA SISWA BERDASARKAN ID ITERASI
    ...
    // 2. AMBIL DATA NILAI SISWA AKTIF (DI-RESET SETIAP LOOP)
    ...
    while ($row = $result_nilai->fetch_assoc()) {
        // Logika rumus rata-rata Anda (S1 sampai S6 dibagi 6)
    ...
    // Reset hitungan total nilai dan jumlah mapel khusus untuk halaman siswa saat ini
    $total_nilai_seluruhnya = 0;
    $jumlah_mapel_terhitung = 0;

    // Fungsi helper versi lokal untuk melacak variabel total per halaman
    $ambilNilaiMassal = function($nama_mapel) use (&$list_nilai, &$total_nilai_seluruhnya, &$jumlah_mapel_terhitung) {
    ...
    <table class="nilai-table">
        ...
        <tbody>
            <tr>
                ...
                <td class="nilai"><?= $ambilNilaiMassal('Pendidikan Agama dan Budi Pekerti'); ?></td>
            </tr>
            <tr>
                <td class="no">2.</td>
                <td>Pendidikan Pancasila</td>
                <td class="nilai"><?= isset($list_nilai['pendidikan pancasila']) ? $ambilNilaiMassal('Pendidikan Pancasila') : $ambilNilaiMassal('PKn'); ?></td>
            </tr>
            <tr>
                <td class="no">3.</td>
                <td>Bahasa Indonesia</td>
                <td class="nilai"><?= $ambilNilaiMassal('Bahasa Indonesia'); ?></td>
            </tr>
            <tr>
                <td class="no">4.</td>
                <td>Matematika</td>
                <td class="nilai"><?= $ambilNilaiMassal('Matematika'); ?></td>
            </tr>
            <tr>
                <td class="no">5.</td>
                <td>Ilmu Pengetahuan Alam</td>
                <td class="nilai"><?= $ambilNilaiMassal('Ilmu Pengetahuan Alam'); ?></td>
            </tr>
            <tr>
                <td class="no">6.</td>
                <td>Ilmu Pengetahuan Sosial</td>
                <td class="nilai"><?= $ambilNilaiMassal('Ilmu Pengetahuan Sosial'); ?></td>
            </tr>
            <tr>
                <td class="no">7.</td>
                <td>Bahasa Inggris</td>
                <td class="nilai"><?= $ambilNilaiMassal('Bahasa Inggris'); ?></td>
            </tr>
            <tr>
                <td class="no">8.</td>
                <td>Pendidikan Jasmani Olahraga dan Kesehatan</td>
                <td class="nilai"><?= isset($list_nilai['pendidikan jasmani olahraga dan kesehatan']) ? $ambilNilaiMassal('Pendidikan Jasmani Olahraga dan Kesehatan') : $ambilNilaiMassal('Penjasorkes'); ?></td>
            </tr>
            <tr>
                <td class="no">9.</td>
                <td>Informatika</td>
                <td class="nilai"><?= $ambilNilaiMassal('Informatika'); ?></td>
            </tr>
            <tr>
                <td class="no">10.</td>
                <td>Seni, Budaya, dan Prakarya</td>
                <td class="nilai"><?= isset($list_nilai['seni, budaya, dan prakarya']) ? $ambilNilaiMassal('Seni, Budaya, dan Prakarya') : $ambilNilaiMassal('Seni Budaya'); ?></td>
            </tr>
            <tr>
                ...
                <td class="nilai">
                    <br>
                    <?= $ambilNilaiMassal('Bahasa Jawa'); ?>
                    <br>
                    <?= $ambilNilaiMassal('BTQ/BTA'); ?>
                </td>
            </tr>
            <tr>
...
<script>
// Langsung memicu perintah cetak browser setelah seluruh halaman termuat
window.print();
</script>
